<?php /*a:1:{s:77:"C:\Users\bbab\PhpstormProjects\binance0\app\admin\view\send_detail\index.html";i:1766029046;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div style="margin: 10px 10px 10px 10px">
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label">代收地址</label>
                            <div class="layui-input-inline">
                                <input type="text" name="wallet_address" placeholder="请输入代收钱包地址" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">下发地址</label>
                            <div class="layui-input-inline">
                                <input type="text" name="to_address" placeholder="请输入下发地址" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
    ...
    layui.use(['form', 'table', 'layer', 'jquery'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'wallet_address', title: '代收钱包地址', minWidth: 250, align: 'center', templet: function(d){
                    return '<div style="word-break: break-all;">' + (d.wallet_address || '-') + '</div>';
                }},
                {field: 'to_address', title: '下发地址', minWidth: 250, align: 'center', templet: function(d){
                    return '<div style="word-break: break-all;">' + (d.to_address || '-') + '</div>';
                }},
                {field: 'token_symbol', title: '代币', width: 100, align: 'center'},
                {field: 'amount', title: '下发金额', width: 150, align: 'center', templet: function(d){
                    if(!d.amount) return '<span style="color: red;">0</span>';
                    var amount = parseFloat(d.amount);
                    var amountStr = amount % 1 === 0 ? amount.toString() : amount.toFixed(8);
